        ...
        <div className='pt-4 pb-8 mx-auto border border-gray-400 border-dotted border-t-0'>
            <a href="https://zhidesign.framer.website/" target="_blank" rel="noopener noreferrer">
                <div className='flex justify-end'>
                    <div className='inline-flex flex-row gap-1 text-txt-color text-xs items-center pr-2 mb-2 hover:scale-105 hover:text-black transform transition duration-300 fade cursor-pointer'>
                        <MoveRight size={12}/>
